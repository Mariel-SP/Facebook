...
class MainActivity : AppCompatActivity() {
    ...
    private fun getAllFeeds(): ArrayList<Feed> {
        ...
        stories.add(Story(R.drawable.im_user_1, "Usuario"))
        stories.add(Story(R.drawable.im_user_2, "Usuario"))
        stories.add(Story(R.drawable.im_user_3, "Usuario"))
        stories.add(Story(R.drawable.im_user_4, "Usuario"))
        stories.add(Story(R.drawable.im_user_5, "Usuario"))
        stories.add(Story(R.drawable.im_user_2, "Usuario"))
        stories.add(Story(R.drawable.im_user_1, "Usuario"))
...
//        var link = intent.getStringExtra("link")
        ...
        feeds.add(Feed(Post(R.drawable.im_post_2, "Usuario", R.drawable.im_user_1)))
        feeds.add(Feed(Post(R.drawable.im_post_1, "Usuario", R.drawable.im_user_2)))
        feeds.add(Feed(Post(R.drawable.im_post_3, "Usuario", R.drawable.im_user_3)))
        feeds.add(Feed(Post(R.drawable.im_post_4, "Usuario", R.drawable.im_user_4)))
        feeds.add(Feed(Post(R.drawable.im_post_5, "Usuario", R.drawable.im_user_5)))
        feeds.add(Feed(Post(R.drawable.im_post_3, "Usuario", R.drawable.im_user_1)))
        feeds.add(Feed(Post(R.drawable.im_post_2, "Usuario", R.drawable.im_user_2)))
